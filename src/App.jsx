...
const SLIDES_DATA = [
  ...
  },
  {
    ...
    items: [
      { date: '1/15', title: '📍 好時多涮涮鍋', desc: '駱彤生日慶生，送一堆蝦子根本吃不完', image: '/eat01.jpg' }, 
      { date: '1/27', title: '📍 和牛涮', desc: '俞祥約歐劍大聚餐，教練、師母也來了!', image: '/eat02.jpg' },
      { date: '3/9', title: '📍 1010 湘餐廳', desc: '攝影展當天的午餐聚會', image: '/eat03.jpg' },
      { date: '3/31', title: '📍 CityLink 港式飲茶', desc: '到南港慶祝秉琛離職', image: '/eat04.jpg' },
      { date: '5/15', title: '📍 六品小館', desc: '張適生日，吃完到張適家聊天小坐', image: '/eat05.jpg' },
      { date: '7/16', title: '📍 岡心食堂', desc: '慶祝秉琛生日，吃完還去參觀無限城', image: '/eat06.jpg' },
      { date: '8/11', title: '📍 史坦利美式牛排', desc: '慶祝秉琛新工作上工', image: '/eat07.jpg' }
    ]
  },
  {
    type: 'memory-story', 
    ...
    items: [
      { date: '3/9', title: '信義區攝影企劃', desc: '駱彤帽子大王 vs 秉琛推箱子服務', icon: 'camera', image: '/memory01.jpg' }, 
      { date: '5/30', title: '秉琛家包粽子', desc: '體驗南部粽製作、蹭好料', icon: 'star', image: '/memory02.jpg' },
      { date: '7/12', title: '宜蘭兩天一夜', desc: '羅東夜市、梅花湖。確立了「鬆散隨緣」的旅行風格', icon: 'map', image: '/memory03.jpg' },
      { date: '10/5', title: '六福村萬聖節', desc: '墓碑鎮遊行，芮妮恐怖又可愛<3', icon: 'ghost', image: '/memory04.jpg' },
      { date: '10/23', title: '秉琛戲劇成發', desc: '全員到齊支持，專業錄影攝影', icon: 'video', image: '/memory05.jpg' }
    ]
  },
  {
    type: 'keywords',
